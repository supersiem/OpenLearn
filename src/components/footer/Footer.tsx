...
export default async function Footer() {
  ...
  return (
    <footer className="w-full bg-neutral-800 pt-4 pb-8 drop-shadow-xl font-[family-name:var(--font-geist-sans)] mt-auto flex flex-row px-4">
      <div className="w-full max-w-screen-xl mx-auto flex flex-row">
        <div>
