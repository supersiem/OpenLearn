          ...
          <PaginationContent>
            <PaginationItem>
              <PaginationPrevious
                href={
                  currentPage > 1
                    ? `/admin/${tabId}?page=${currentPage - 1}`
                    : "#"
                }
                className={
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <span>
                      {user.forumAllowed
                        ? ""
                        : ` reden: ${
                            user.forumBanReason || "geen reden opgegeven"
                          }`}
                ...
                <div className={` flex items-center cursor-pointer`}>
                  ...
                  <div className="flex flex-col flex-1">
                    ...
                    <span>
                      ...
                      {userMapById[groep.creator]?.name ||
                        "Onbekende gebruiker"}
                    </span>
                  </div>
                </div>
